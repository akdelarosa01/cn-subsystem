    			...
    			<div class="col-xs-12">
    				<table class="table" style="font-size: 10px">
                        ...
                        <tr>
                            ...
                            <td class="align-left">{{ $header->prod_category }}</td>
                            <th class="align-left">COC Requirements</td>
                            <td>{{ $header->coc_req }}</td>
                        ...
                        <tr>
                            ...
                            <td>{{ $header->severity_of_inspection }}</td>
